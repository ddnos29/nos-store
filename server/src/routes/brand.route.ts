...
router.post('/', brandValidator.create, asyncHandler(brandController.createBrand));

router.put('/:id', brandValidator.update, asyncHandler(brandController.updateBrand));
